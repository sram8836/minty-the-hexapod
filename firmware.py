...
cal[3].apply_two_pairs(1020, 2070, -45, 45), # 4: R33
cal[4].apply_two_pairs(870, 1900, -45, 45), # 5: R32
cal[5].apply_two_pairs(980, 2060, -45, 45), # 6: R31
cal[6].apply_two_pairs(940, 1910, -45, 45), # 7: L21
cal[7].apply_two_pairs(950, 1950, -45, 45), # 8: L22
...
cal[15].apply_two_pairs(910, 1930, -45, 45), # 16: R13
cal[16].apply_two_pairs(1030, 2020, -45, 45), # 17: R11
cal[17].apply_two_pairs(1060, 2020, -45, 45), # 18: R12

# Reversed joints
cal[0].apply_two_pairs(2020, 1020, -45, 45), # 1: L31
cal[1].apply_two_pairs(2000, 1000, -45, 45), # 2: L32
...
cal[9].apply_two_pairs(1990, 1040, -45, 45), # 10: R23
cal[10].apply_two_pairs(2000, 1000, -45, 45), # 11: R22
cal[11].apply_two_pairs(1930, 910, -45, 45), # 12: R21
cal[12].apply_two_pairs(1900, 890, -45, 45), # 13: L11
cal[13].apply_two_pairs(1930, 880, -45, 45), # 14: L12
